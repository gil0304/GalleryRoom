/*! GalleryRoom.js v1.0.0 | MIT License | A JavaScript/CSS library for creating web exhibition galleries. */
(function (global) {
"use strict";
...
const MEDIA_TYPES = ["image", "video", "youtube", "iframe", "text"];
 ...
 */
function renderMedia(work, options) {
  const opts = options || {};
...
function findCurrentWorkId(wallElement, workElements, horizontal) {
  let bestId = null;
...
const DEPTH_VALUES = [0, 40, -20, 60, 10];
const ROTATE_VALUES = [0, -4, 3, -2, 5];
const HEIGHT_VALUES = [0, -12, 8, -6, 10];

const THEME_DEPTH_INTENSITY = {
  "white-cube": 0.6,
  "dark-room": 1,
  "zine-wall": 1,
  "portfolio-clean": 0.5,
...
function resolveDepth(work, index, theme, layout) {
...
function applyDepthVars(element, values) {
